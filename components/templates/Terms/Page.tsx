...
const Page: React.FC<Props> = (props) => {
    ...
    return (
        <div
            className={`container flex justify-center ${app ? "" : "pt-10 md:pt-20"} mx-auto mb-20 text-secondary-300`}
        >
            <div className="py-8 md:py-16 px-4 md:px-20 max-w-5xl text-sm md:text-base leading-relaxed bg-white-300 md:rounded-xl">
                <div>
                    {!app && <h1 className="pb-5 md:pb-8 text-2xl md:text-4xl">利用規約</h1>}
                    <div className={`${textClassName}`}>
                        <p>
                            この利用規約（以下、「本規約」といいます。）は、memoir（以下、「当サービス」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
                        </p>
                    </div>

                    <h2 className="py-5 text-lg md:text-xl">第1条（適用）</h2>
                    <ol className={`pl-4 md:pl-10 ${textClassName} list-decimal`}>
                        <li>
                    ...
                    <h2 className="py-5 text-lg md:text-xl">第2条（利用登録）</h2>
                    <ol className={`pl-4 md:pl-10 ${textClassName} list-decimal`}>
                        <li>
                    ...
                    <h2 className="py-5 text-lg md:text-xl">第3条（ユーザーIDおよびパスワードの管理）</h2>
                    <ol className={`pl-4 md:pl-10 ${textClassName} list-decimal`}>
                        <li>
                    ...
                    <h2 className="py-5 text-lg md:text-xl">第4条（利用料金および支払方法）</h2>
                    <ol className={`pl-4 md:pl-10 ${textClassName} list-decimal`}>
                        <li>
                            ユーザーは、本サービスの有料部分の対価として、当サービスが別途定め、本ウェブサイトに表示する利用料金を、当サービスが指定する方法により支払うものとします。
                        </li>
                        <li>
                    ...
                    <h2 className="py-5 text-lg md:text-xl">第5条（禁止事項）</h2>
                    <div className={`${textClassName}`}>
                    ...
                    <h2 className="py-5 text-lg md:text-xl">第6条（本サービスの提供の停止等）</h2>
                    ...
                    <h2 className="py-5 text-lg md:text-xl">第7条（利用制限および登録抹消）</h2>
                    <ol className={`pl-4 md:pl-10 ${textClassName} list-decimal`}>
                        <li>
                    ...
                    <h2 className="py-5 text-lg md:text-xl">第8条（退会）</h2>
                    <div className={`${textClassName}`}>
                        <p>ユーザーは、当サービスの定める退会手続により、本サービスから退会できるものとします。</p>
                    </div>

                    <h2 className="py-5 text-lg md:text-xl">第9条（保証の否認および免責事項）</h2>
                    <ol className={`pl-4 md:pl-10 ${textClassName} list-decimal`}>
                        <li>
                            当サービスは、本サービスに事実上または法律上の瑕疵（安全性、信頼性、正確性、完全性、有効性、特定の目的への適合性、セキュリティなどに関する欠陥、エラーやバグ、権利侵害などを含みます。）がないことを明示的にも黙示的にも保証しておりません。
                        </li>
                        <li>
                            当サービスは、本サービスに起因してユーザーに生じたあらゆる損害について、当サービスの故意又は重過失による場合を除き、一切の責任を負いません。ただし、本サービスに関する当サービスとユーザーとの間の契約（本規約を含みます。）が消費者契約法に定める消費者契約となる場合、この免責規定は適用されません。
                        </li>
                        <li>
                    ...
                    <h2 className="py-5 text-lg md:text-xl">第10条（サービス内容の変更等）</h2>
                    <div className={`${textClassName}`}>
                        <p>
                    ...
                    <h2 className="py-5 text-lg md:text-xl">第11条（利用規約の変更）</h2>
                    <ol className={`pl-4 md:pl-10 ${textClassName} list-decimal`}>
                        <li>
                    ...
                    <h2 className="py-5 text-lg md:text-xl">第12条（個人情報の取扱い）</h2>
                    <div className={`${textClassName}`}>
                        <p>
                    ...
                    <h2 className="py-5 text-lg md:text-xl">第13条（通知または連絡）</h2>
                    <div className={`${textClassName}`}>
                        <p>
                    ...
                    <h2 className="py-5 text-lg md:text-xl">第14条（権利義務の譲渡の禁止）</h2>
                    <div className={`${textClassName}`}>
                        <p>
                    ...
                    <h2 className="py-5 text-lg md:text-xl">第15条（準拠法・裁判管轄）</h2>
                    <ol className={`pl-4 md:pl-10 ${textClassName} list-decimal`}>
                ...
                {!app && (
                    <div className="pt-10 leading-normal">
