    ...
    return (
        ...
        >
            <div className="py-8 md:py-16 px-4 md:px-20 max-w-5xl text-sm md:text-base leading-relaxed bg-white-300 md:rounded-xl">
                <div>
                    {!app && <h1 className="pb-5 md:pb-8 text-2xl md:text-4xl">プライバシーポリシー</h1>}
                    <div className={`${textClassName}`}>
                        <p>
                            memoir（以下、「当サービス」といいます。）は、本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。
                        </p>
                    </div>
                    <h2 className="py-5 text-lg md:text-xl">第1条（個人情報）</h2>
                    <div className={`${textClassName}`}>
                        <p>
                    ...
                    <h2 className="py-5 text-lg md:text-xl">第2条（個人情報の収集方法）</h2>
                    <div className={`${textClassName}`}>
                        <p>
                    ...
                    <h2 className="py-5 text-lg md:text-xl">第3条（個人情報を収集・利用する目的）</h2>
                    ...
                    <h2 className="py-5 text-lg md:text-xl">第4条（利用目的の変更）</h2>
                    <ol className={`pl-4 md:pl-10 ${textClassName} list-decimal`}>
                        <li>
                    ...
                    <h2 className="py-5 text-lg md:text-xl">第5条（個人情報の第三者提供）</h2>
                    <ol className={`pl-4 md:pl-10 ${textClassName} list-decimal`}>
                        <li>
                    ...
                    <h2 className="py-5 text-lg md:text-xl">第6条（個人情報の開示）</h2>
                    <ol className={`pl-4 md:pl-10 ${textClassName} list-decimal`}>
                        <li>
                    ...
                    <h2 className="py-5 text-lg md:text-xl">第7条（個人情報の訂正および削除）</h2>
                    <ol className={`pl-4 md:pl-10 ${textClassName} list-decimal`}>
                        <li>
                    ...
                    <h2 className="py-5 text-lg md:text-xl">第8条（個人情報の利用停止等）</h2>
                    <ol className={`pl-4 md:pl-10 ${textClassName} list-decimal`}>
                        <li>
                    ...
                    <h2 className="py-5 text-lg md:text-xl">第9条（プライバシーポリシーの変更）</h2>
                    <ol className={`pl-4 md:pl-10 ${textClassName} list-decimal`}>
                        <li>
