...
const Promotion = () => {
    return (
        <div className="flex flex-col justify-center items-center p-5 md:p-16 my-8 bg-white-900 rounded-xl">
            <div className="text-2xl md:text-3xl leading-snug text-center">
                広告は一切なし、 <br />
                機能はすべて無料で使えます
            </div>
            <br />
            <div className="text-xs md:text-sm leading-6 text-center">
